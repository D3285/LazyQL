...
import { createDatabaseSession } from "../api/session";
        ...
        <section className="w-full max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <p className="mt-3 font-mono text-xs text-[#737d8d]">
              Choose your database type and provide a connection URL.
            </p>
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="mt-3 font-mono text-[9px] leading-5 text-[#626b7b]">
                  {databaseType === "postgresql"
                    ...
                    : "Provide the SQLite connection URL accepted by the backend."}
                </p>
              ...
              <div className="border-t border-[#272238] bg-[#11101a] p-6 lg:border-l lg:border-t-0">
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <GuideItem
                    number="02"
                    title="Provide URL"
                    text="Use the format expected by the backend."
                  />
...
function GuideItem({
  ...
  return (
    <div className="flex gap-3">
      ...
      <span className="font-mono text-[8px] text-[#7545dc]">
        {number}
      </span>
      ...
      <div>
        ...
        <div className="mt-1 text-[10px] leading-5 text-[#666f80]">
          {text}
        </div>
